...
class ProductApi(object):
    ...
    def list_products(self, page, **kwargs):  # noqa: E501
        ...
        :param str type:  列表数据类型支持: all|live|sold_out|delisted 默认 all
    ...
    def list_products_with_http_info(self, page, **kwargs):  # noqa: E501
        ...
        all_params = ['page', 'page_size', 'orderby', 'sort', 'type', 'search', 'group_id', 'category_id', 'sold_out', 'price']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
