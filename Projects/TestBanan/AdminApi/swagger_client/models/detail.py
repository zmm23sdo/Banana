...
class Detail(object):
    ...
    @property
    def type(self):
        """Gets the type of this Detail.  # noqa: E501

         类型: route:权限, pgroup: 分组  # noqa: E501

        :return: The type of this Detail.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this Detail.  # noqa: E501
        :type: str
        """
        if type is None:
